    ...
    return (
        <Paper elevation={0} sx={{ width: "60%", padding: "5vw", display: "flex", justifyContent: "center" }} >
            ...
            <Typography variant='h2' textAlign='left' gutterBottom>About</Typography>
                ...
                <Typography variant='body2' color="text.secondary" textAlign="justify" gutterBottom>This is a Web App built using the <Link  href="https://reactjs.org/" rel="noopener" target="_blank">React</Link> framework incorporating
